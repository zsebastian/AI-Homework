...
Evolver::Evolver(Coord start, Coord end, int population_size, int genome_size, double combination_probability, double mutation_probability, double selection_probability)
